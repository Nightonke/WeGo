...
public class NetworkTools {
    ...
    public static int RESULT_PERMISSION_DENY = 401;
    public static int RESULT_SERVER_FAILED = 501;
    public static int RESULT_USER_LOGIN_REQUESTED = 402;
    public static int RESULT_TIMESTAMP_ERROR = 8000;
    public static int ACTION_QUERY = 1;
    public static int ACTION_REMOVE = 2;
    public static int ACTION_INSERT = 3;
    public static int ACTION_UPDATE = 4;
