 ...
 */
public class MySubscribeExerciseAdapter
        extends RecyclerView.Adapter<MySubscribeExerciseAdapter.ViewHolder> {

    private OnExerciseSelectListener onExerciseSelectListener;
    private Context context;

    public MySubscribeExerciseAdapter(OnExerciseSelectListener onExerciseSelectListener) {
